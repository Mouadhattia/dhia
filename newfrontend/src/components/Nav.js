    ...
    return (
        <nav ref={Nav} className={`nav active`} >
            ...
            { /* nav links */}
            {
                !showSearchIc ?
                    <ul className="navLinks" ref={navLinks}>
                        <NavLink to="/shop" activeClassName='activlink' onClick={onBurgActive} ><li>Boutique</li></NavLink>
                        <NavLink to="/contactus" activeClassName='activlink' onClick={onBurgActive}  ><li>Contact</li></NavLink>
                        <NavLink to="/about" activeClassName='activlink' onClick={onBurgActive} ><li>À propos</li></NavLink>
                    </ul> : <div></div>
            }
            ...
            <div className="rightComp" ref={rightItems}>
                { /* card icon */}
                <Link onClick={onBurgActive} to='/cart' > <RiShoppingCart2Line className='iconCart' size='35' />
                    {
                ...
                {userInfo ? (<div className="ic_sett_dis"><Link to="/profile"><CgProfile size="25" className="settingIcon" /></Link>
                    <IoMdLogOut size='28' className="displayIcon" onClick={logoutHandler} />
                </div>
                ) : <Link onClick={onBurgActive} to='/login' > <div className='signin' onMouseOver={() => setSignin(!signin)} onMouseOut={() => setSignin(!signin)}  >S'identifier
                </div>
                </Link>}
