...
axios.defaults.baseURL = "http://51.83.43.241:5000";
const Home = () => {
          ...
          <div className="text">
            ...
            <div style={{ marginTop: 5, marginBottom: 20 }}>
              <lu>
                ...
                <li>
                  Tous nos produits sont fabriqués à partir de matériaux
                  recyclés, en particulier de bois de palette.
                </li>
                <li>
                  Nos créations sur-mesure vous permettent de répondre
